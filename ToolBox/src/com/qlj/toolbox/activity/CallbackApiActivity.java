...
import com.qlj.toolbox.api.IResponseListener;
import com.qlj.toolbox.api.LoginApi;
 ...
 */
public class CallbackApiActivity extends Activity {
	...
	private void login() {
		...
		new Thread() {
			public void run() {
				try {
					LoginApi.login("15889722562", MD5.MD5Encode("000000"), "1", new IResponseListener() {
